...
<div class="container">
    ...
    <div class="col-sm-3">
	<figure>
    <img src="${images}/35.jpg"  class="img-rounded" width="200" height="200" >  
     <figcaption><strong></strong><br><center>$10</center></figcaption>
</figure>
	</div>
    <div class="col-sm-3">
	<figure>
     <img src="${images}/34.jpg" class="img-rounded" width="200" height="200" >
	  <figcaption><strong></strong><br><center>$11</center></figcaption>
</figure>
	 </div>
	 <div class="col-sm-3">
	 <figure>
     <img src="${images}/36.jpg"  class="img-rounded" width="200" height="200" >
	  <figcaption><strong>valentine cake special</strong><br><center>$11.5</center></figcaption>
</figure>
	 </div>
	 <div class="col-sm-3">
	 <figure>
    <img src="${images}/37.png"  class="img-rounded" width="200" height="200" >  
...
<div class="container">
    <div class="row">
    <div class="col-sm-3">
    <img src="${images}/38.png"  class="img-rounded" width="200" height="200" >  
        <figcaption><strong>royal cake</strong><br><center>$9</center></figcaption>
</figure>
  
  </div>
    <div class="col-sm-3">
     <img src="${images}/39.jpg"  class="img-rounded" width="200" height="200" >
	      <figcaption><strong>fruits fanda</strong><br><center>$11</center></figcaption>
</figure>

	 </div>
	 <div class="col-sm-3">
     <img src="${images}/40.png"  class="img-rounded" width="200" height="200" >
     <figcaption><strong>choco valentine</strong><br><center>$8</center></figcaption>
</figure>
	
	</div>
	 <div class="col-sm-3">
    <img src="${images}/41.jpg"  class="img-rounded" width="200" height="200" >  
...
<div class="container">
    <div class="row">
    <div class="col-sm-3">
    <img src="${images}/42.jpg"  class="img-rounded" width="200" height="200" >  
   <figcaption><strong>royal pinky cake</strong><br><center>$13</center></figcaption>
</figure>
</div>
    <div class="col-sm-3">
     <img src="${images}/7.jpg"  class="img-rounded" width="200" height="200" >
     <figcaption><strong>chococherry down</strong><br><center>$12.5</center></figcaption>
</figure>

	 </div>
	 <div class="col-sm-3">
     <img src="${images}/6.jpg"  class="img-rounded" width="200" height="200" >
