...
<div class="container">
    ...
    <div class="col-sm-3">
	<figure>
    <img src="${images}/48.jpg"  class="img-rounded" width="200" height="200" >  
     <figcaption><strong></strong><br><center>$10</center></figcaption>
</figure>
	</div>
    <div class="col-sm-3">
	<figure>
     <img src="${images}/10.jpg"  class="img-rounded" width="200" height="200" >
	  <figcaption><strong></strong><br><center>$11</center></figcaption>
</figure>
	 </div>
	 <div class="col-sm-3">
	 <figure>
     <img src="${images}/11.jpg"  class="img-rounded" width="200" height="200" >
	  <figcaption><strong>valentine cake special</strong><br><center>$11.5</center></figcaption>
</figure>
	 </div>
	 <div class="col-sm-3">
	 <figure>
    <img src="${images}/12.jpg"  class="img-rounded" width="200" height="200" >  
...
<div class="container">
    <div class="row">
    <div class="col-sm-3">
    <img src="${images}/13.jpg"  class="img-rounded" width="200" height="200" >  
        <figcaption><strong>royal cake</strong><br><center>$9</center></figcaption>
</figure>
  
  </div>
    <div class="col-sm-3">
     <img src="${images}/14.jpg"  class="img-rounded" width="200" height="200" >
	 ...
	 <div class="col-sm-3">
    <img src="${images}/20.jsp.jpg"  class="img-rounded" width="200" height="200" >  
...
<div class="container">
    <div class="row">
    <div class="col-sm-3">
    <img src="${images}/16.jsp.jpg"  class="img-rounded" width="200" height="200" >  
   <figcaption><strong>royal pinky cake</strong><br><center>$13</center></figcaption>
</figure>
</div>
    <div class="col-sm-3">
     <img src="${images}/18.jsp.jpg"  class="img-rounded" width="200" height="200" >
     <figcaption><strong>chococherry down</strong><br><center>$12.5</center></figcaption>
</figure>

	 </div>
	 <div class="col-sm-3">
     <img src="${images}/21.jpg"  class="img-rounded" width="200" height="200" >
     <figcaption><strong>rose birthdy cake</strong><br><center>$10.3</center></figcaption>
</figure>

	 </div>
	 <div class="col-sm-3">
    <img src="${images}/17.jsp.png"  class="img-rounded" width="200" height="200" >  
...
<div class="container">
    ...
    <div class="col-sm-3">
	 ...
	 <div class="col-sm-3">
    <img src="${images}/new4.jpg"  class="img-rounded" width="200" height="200" >  
